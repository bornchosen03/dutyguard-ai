...
├── customer-portal/                # React dashboard (Vite + TypeScript)
...
- Node.js 18+ (for customer portal)
...
- **Customer Portal**: React, Vite, TypeScript
...
**Note**: If you prefer a different backend (Node.js/Nest/Express) or customer portal (Next.js), tell me and I can re-scaffold accordingly.
